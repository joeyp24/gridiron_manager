...
func _build_interface() -> void:
	...
	team_column.add_child(UIFactory.label("2026 Pro League", "SectionTitleLabel"))
	team_column.add_child(UIFactory.label("All 32 professional clubs", "CaptionLabel"))
...
func _rebuild_details() -> void:
	...
	identity_copy.add_child(UIFactory.label("%s · %s · 53-player roster" % [team.conference, team.division], "MutedLabel"))
